export function questionReplyTemplate(userName, questionTitle, questionLink) {
    return `
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    <div class="container">
        <div class="header"><h1>Nouvelle réponse</h1></div>
        <div class="content">
            <p>Bonjour ${userName},</p>
            <p>Quelqu'un a répondu à votre question : <strong>${questionTitle}</strong></p>
            <a class="cta-button" href="${questionLink}">Voir la réponse</a>
        </div>
